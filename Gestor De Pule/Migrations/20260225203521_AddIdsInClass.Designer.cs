...
namespace Gestor_De_Pule.Migrations
{
    ...
    [Migration("20260225203521_AddIdsInClass")]
    partial class AddIdsInClass
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gestor_De_Pule.src.Model.Pule", b =>
                {
                    ...
                    b.Property<int?>("ApostadorId1")
                        .HasColumnType("INTEGER");

                    b.Property<DateTime>("Date")
                        .HasColumnType("TEXT");

                    b.Property<int?>("DisputaId1")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ApostadorId1");

                    b.HasIndex("DisputaId1");
            ...
            modelBuilder.Entity("Gestor_De_Pule.src.Model.Pule", b =>
                {
                    b.HasOne("Gestor_De_Pule.src.Model.Apostador", "Apostador")
                        .WithMany("Pules")
                        .HasForeignKey("ApostadorId1");

                    b.HasOne("Gestor_De_Pule.src.Models.Disputa", "Disputa")
                        .WithMany("Pules")
                        .HasForeignKey("DisputaId1");
